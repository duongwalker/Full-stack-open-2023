...
const mostBlogs = (blogs) => {
    ...
    const maxAuthor = Object.keys(authorCount).reduce(function(a, b){ return authorCount[a] > authorCount[b] ? a : b })
    return {
        author: maxAuthor,
...
const mostLikes = (blogs) => {
    ...
    const likes = _.mapValues(authorCount, (o) => o.reduce((acc, cur) => acc + cur.likes, 0))
    const mostLikedAuthor = Object.keys(likes).reduce((a, b) => likes[a] > likes[b] ? a : b)
    return {
